...
import com.mercadopago.android.px.internal.features.express.slider.CardMediumFragment.Companion.getInstance
...
class PaymentMethodMediumDrawer : PaymentMethodFragmentDrawer {
    ...
    override fun draw(drawableItem: ConsumerCreditsDrawableFragmentItem): Fragment {
        return ConsumerCreditsMediumFragment.getInstance(drawableItem)
    }
}