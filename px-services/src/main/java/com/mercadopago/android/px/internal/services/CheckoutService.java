...
public interface CheckoutService {
    ...
    @POST("https://run.mocky.io/v3/a2fdb534-e444-48cd-b9e2-ddb52bfe9f79/" + ENVIRONMENT + "/px_mobile/" + CHECKOUT_VERSION + "/checkout")
    MPCall<CheckoutResponse> checkout(
        @Query("access_token") String privateKey,
        @Body Map<String, Object> body);

    @POST("https://run.mocky.io/v3/a2fdb534-e444-48cd-b9e2-ddb52bfe9f79/" + ENVIRONMENT + "/px_mobile/" + CHECKOUT_VERSION + "/checkout/{preference_id}")
    MPCall<CheckoutResponse> checkout(
